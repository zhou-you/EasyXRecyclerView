 ...
 * 版本： v1.0<br>
 */
public class GroupedStickyListAdapter extends GroupedRecyclerViewAdapter<GroupBean> {
    public GroupedStickyListAdapter(Context context) {
        super(context);
    }

    public GroupedStickyListAdapter(Context context, List<GroupBean> list) {
        super(context, list);
    }
    ...
    public void onBindHeaderViewHolder(HelperRecyclerViewHolder holder, int groupPosition, GroupBean item) {
        ...
        holder.itemView.setTag("sticky");//设置粘性的TAG
